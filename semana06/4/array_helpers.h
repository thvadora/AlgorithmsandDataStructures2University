...
bool array_is_permutation_of(unsigned int a[], unsigned int other[], unsigned int length);
/*
...
void array_copy(unsigned int dst[], unsigned int src[], unsigned int length);
/* 
   Copy the array 'src' into the array 'dst' 
*/

unsigned int array_from_file(unsigned int a[], unsigned int max_size, const char *filepath);
/*
